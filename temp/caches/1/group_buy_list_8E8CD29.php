<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:57:"D:/phpStudy/www/themes/ecmoban_dsc2017/group_buy_list.dwt";i:1;s:67:"D:/phpStudy/www/themes/ecmoban_dsc2017/library/js_languages_new.lbi";i:2;s:69:"D:/phpStudy/www/themes/ecmoban_dsc2017/library/page_header_common.lbi";i:3;s:58:"D:/phpStudy/www/themes/ecmoban_dsc2017/library/ur_here.lbi";i:4;s:62:"D:/phpStudy/www/themes/ecmoban_dsc2017/library/page_footer.lbi";}s:7:"expires";i:1559288191;s:8:"maketime";i:1559284591;}<!doctype html>
<html>
<head>
                    ...
                    <div class="s-l-wrap">
                        ...
                        <div class="s-l-value">
                            <div class="s-l-v-list">
                                <ul>
                                    <li class="curr"><a href="group_buy.php?act=list">全部</a></li>
                                                                        <li ><a href="group_buy.php?act=list&sort=&cat_id=1#group_buy_list">svci</a></li>
                                                                        <li ><a href="group_buy.php?act=list&sort=&cat_id=2#group_buy_list">fvdi</a></li>
                                                                        <li ><a href="group_buy.php?act=list&sort=&cat_id=3#group_buy_list">baochi</a></li>
                                                                        <li ><a href="group_buy.php?act=list&sort=&cat_id=4#group_buy_list">key_programmer</a></li>
                                                                    </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mod-list-sort">
                <form method="GET" class="sort" name="listform">
                    <div class="sort-l fl">
                        ...
                        <a href="group_buy.php?act=list&cat_id=0&price_min=&price_max=&page=&sort=act_id&order=DESC" class="sort-item ">默认<i class="iconfont icon-up1"></i></a>
                        <a href="group_buy.php?act=list&cat_id=0&price_min=&price_max=&page=&sort=start_time&order=DESC" class="sort-item ">最新<i class="iconfont icon-up1"></i></a>
                        <a href="group_buy.php?act=list&cat_id=0&price_min=&price_max=&page=&sort=comments_number&order=DESC" class="sort-item ">评论数<i class="iconfont icon-up1"></i></a>
                    </div>
                    <div class="f-search">
                        <input name="keywords" type="text" class="text" value="" placeholder="活动名称" />
                        <a href="javascript:void(0);" class="btn sc-redBg-btn ui-btn-submit">确定</a>
                    </div>
