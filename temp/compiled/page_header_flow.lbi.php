...
<div class="header header-cart">
    <div class="w w1200">
        <div class="logo">
            ...
            <div class="tit"><?php if ($this->_var['step'] == "cart"): ?><?php echo $this->_var['lang']['cat_list']; ?>（<em ectype="cartNum">0</em>）<?php else: ?><?php echo $this->_var['lang']['settlement_page']; ?><?php endif; ?></div>
        </div>
