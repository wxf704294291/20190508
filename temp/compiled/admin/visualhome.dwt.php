                                                    ...
                                                    <div class="insertVipEdit" data-mode="insertVipEdit">
                                                        ...
                                                        <div class="vip-item">
                                                            ...
                                                            <div class="con">
                                                                ...
                                                                <ul style="display: none;">
                                                                    <li><a href="article.php?id=61" target="_blank">xxxxxxxx</a></li>
                                                                    <li><a href="article.php?id=58" target="_blank">xxxxxxxx</a></li>
                                                                    <li><a href="article.php?id=64" target="_blank">xxxxxxxx</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="vip-item">
